...
(function(){
  ...
  function open(mod){
    ...
    var tEl=mod.querySelector('.mk-t')||mod.querySelector('.acard-pill .lbl');
    var icEl=mod.querySelector('.mk-t svg')||mod.querySelector('.acard-pill .ico svg');
    elTitle.textContent=tEl.textContent.trim();
    elIc.innerHTML=icEl?'<svg viewBox="0 0 24 24">'+icEl.innerHTML+'</svg>':'';
