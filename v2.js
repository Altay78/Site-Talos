    ...
    function sync(){
      if(state.day&&state.slot){
        ...
        if(btn){btn.classList.add('ready');
          var base=btn.getAttribute('data-href')||'reserver-v2.html';
...
(function(){
  ...
  function render(k){
    ...
    res.innerHTML='<div class="reco-card"><div class="reco-eyebrow">NOTRE RECO POUR '+s.l.toUpperCase()+'</div><h3>Ces 3 automatisations vont vous libérer.</h3><div class="reco-autos">'+cards+'</div><p class="reco-reason">'+s.reason+'</p><div class="reco-line"><span class="pl">PLAN CONSEILLÉ</span><span class="pn">'+s.plan+'</span><a href="pricing-v2.html" class="btn btn-primary" style="min-height:46px;font-size:14px">Voir ce plan<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M5 12h14M13 5l7 7-7 7"/></svg></a></div></div>';
