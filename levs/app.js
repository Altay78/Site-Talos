...
(function () {
  ...
  const CAT_INFO = {
    ...
    tacos:      { name: 'Nos tacos',      emoji: '🌮', img: 'https://img.cuisineaz.com/660x495/2025/05/28/i205118-french-tacos-de-o-tacos.jpg', fallback: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1000&auto=format&fit=crop&q=80', desc: 'French tacos façon O\'Tacos : galette grillée à la plancha, sauce fromagère onctueuse. 1, 2 ou 3 viandes au choix.' },
    americain:  { name: 'L\'Américain',   emoji: '🍗', img: 'https://www.jeveuxtoutgouter.com/upload/sandwich-americain-1638346953-44017.jpg', fallback: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=1000&auto=format&fit=crop&q=80', desc: 'Sandwich américain garni — steak, merguez ou veggie — frites maison à la graisse de bœuf incluses.' }
  };
